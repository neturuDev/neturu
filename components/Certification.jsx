...
export default function Certification({ title, image, issuingOrganization, issued, credentialLink }) {
    return (
        <div className='certification'>
            <img src={image.url} alt={title} width={image.metadata.pixelWidth} height={image.metadata.pixelHeight} />
            <div className='certification-data'>
                ...
                {credentialLink && (
                    <div className='certification-link-wrapper'>
                        <a className='certification-link' href={credentialLink} target='_blank' rel='noreferrer'>
