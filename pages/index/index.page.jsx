                ...
                H273.455z'
                    ...
                    <div className='socials'>
                        <div className='social'>
                            <a href='https://www.linkedin.com/in/cherevchuk/' className='social-link button-shape' target='_blank' rel='noreferrer'>
                        ...
                        <div className='social'>
                            <a href='https://github.com/neturuDev' className='social-link button-shape' target='_blank' rel='noreferrer'>
                        ...
                        <div className='social'>
                            <a href='/about' className='button button-shape'>
                                {'About me'}
                            </a>
                        </div>
                    </div>
