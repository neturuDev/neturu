        ...
        <div className='about-card'>
          ...
          <div className='socials'>
            <div className='social'>
              <a href='https://www.linkedin.com/in/cherevchuk/' className='social-link' target='_blank' rel='noreferrer'>
            ...
            <div className='social'>
              <a href='https://github.com/neturuDev' className='social-link' target='_blank' rel='noreferrer'>
